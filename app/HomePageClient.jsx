...
import GridStars from '../components/GridStars';

import { TbServerBolt } from "react-icons/tb";
import { FiDollarSign } from "react-icons/fi";
import { LuLayoutDashboard, LuCpu } from "react-icons/lu";
...
export default function HomePageClient() {
  ...
  return (
    <ClickSpark sparkSize={10} sparkRadius={17} sparkCount={6} duration={400}>
      <Navbar />
      <div className="min-h-screen bg-page overflow-hidden flex flex-col items-center">

        {/* Soft ambient glow */}
        <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[min(900px,100%)] h-[420px] z-0"
          style={{ background: 'radial-gradient(ellipse 70% 55% at 50% 0%, rgba(99,102,241,0.16) 0%, rgba(168,85,247,0.08) 40%, transparent 72%)',}}
        />

        {/* Graph lines, late fade, cursor:hover glow on desktop */}
        <div
          className="absolute top-0 z-0 w-full h-[100vh]"
          style={{
            maskImage:
              'linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 62%, rgba(255,255,255,0.75) 82%, rgba(255,255,255,0.25) 93%, rgba(255,255,255,0) 100%)',
            WebkitMaskImage:
              'linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 62%, rgba(255,255,255,0.75) 82%, rgba(255,255,255,0.25) 93%, rgba(255,255,255,0) 100%)',
          }}
        >
        ...
        {/* Hero Section */}
        <section className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 pt-32 sm:pt-36 pb-20 sm:pb-24 min-h-[86vh] flex items-center">

          <div className="w-full grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-16 xl:gap-24 lg:items-end">

            {/* Message column */}
            <div className="max-w-3xl">

              <h1
                className="mt-6 text-[2.6rem] leading-[1.05] sm:text-6xl lg:text-[3.8rem] text-white tracking-tight"
              ...
              <p
                className="mt-6 text-[15px] sm:text-lg text-gray-400 leading-relaxed max-w-xl"
                data-aos="fade-up"
                data-aos-duration="700"
                data-aos-delay="160"
              >
                Affordable cloud hosting starting at $0.65/mo. Deploy websites, bots, game servers, databases, and more with KVM VPS and cloud containers across 3 locations.
              </p>
              ...
              >
                <button
                  className="px-7 py-3 bg-linear-to-b from-purple-500 to-purple-800 text-white rounded-full hover:opacity-90 transition-opacity shadow-lg shadow-purple-900/40 flex items-center justify-center group font-medium"
                ...
                <button
                  className="px-7 py-3 text-white bg-surface-elevated rounded-full transition-all border border-night-600 hover:bg-night-600 hover:border-accent-violet/30 flex items-center justify-center group font-medium"
                  onClick={() => {
              ...
              <p
                className="mt-7 text-[13px] text-gray-500"
                data-aos="fade-up"
                data-aos-duration="700"
                data-aos-delay="300"
              >
                Trusted by 1,500+ developers · 200+ servers running
              </p>
            </div>

            {/* Info rail — products, pricing, locations at a glance */}
            <dl
              className="mt-14 lg:mt-0 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-1 gap-x-6 gap-y-8 lg:gap-y-7
                         pt-10 lg:pl-10 lg:text-right"
              data-aos="fade-up"
              data-aos-duration="700"
              data-aos-delay="360"
            >
              <div>
                <dt className="text-[10px] tracking-[0.2em] uppercase text-gray-500">Products</dt>
                <dd className="mt-2 text-sm text-gray-200 leading-relaxed">
                  Containers · VPS
                  <span className="block">Game · Web</span>
                </dd>
              </div>
              <div>
                <dt className="text-[10px] tracking-[0.2em] uppercase text-gray-500">Starting at</dt>
                <dd className="mt-2 text-sm text-gray-200">
                  <span className="text-white text-base" style={{ fontFamily: 'Nohemi, sans-serif' }}>$0.65</span>
                  <span className="text-gray-400"> / month</span>
                </dd>
              </div>
              <div>
                <dt className="text-[10px] tracking-[0.2em] uppercase text-gray-500">Locations</dt>
                <dd className="mt-2 text-sm text-gray-200 leading-relaxed">
                  Dallas, US
                  <span className="block">Utah. US</span>
                  <span className="block">Frankfurt, DE</span>
                </dd>
              </div>
            </dl>
          </div>
        ...
        <div className="relative w-full mt-20 overflow-hidden rounded-t-[40px]" id="products-section">          
          ...
          <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" className="relative z-10 text-center mb-12 mt-5">
            <span className="text-cyan-500 text-sm p-2 px-5 rounded-full bg-linear-to-t from-transparent relative font-semibold gradient-border-purple"
              style={{
        ...
        <div className="relative w-full mt-20" id='locations-section'>
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              <span className="text-cyan-500 text-sm p-2 px-5 rounded-full bg-gradient-to-t from-transparent relative font-semibold mb-4 inline-block gradient-border-purple"
                style={{
                  border: '1px solid transparent',
                }}
              ...
              <p  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" data-aos-offset="30" className="text-gray-400 text-[15px] mx-auto">Tier III datacenter in 2 locations, running on high quality hardware for the best experience.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" data-aos-offset="30" className="purple-glow-card">
                <div className="flex flex-col items-start gap-2 mb-2">
                  <h3 className="text-white font-semibold text-xl">Utah, US</h3>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed mb-5">Affordable datacenter powered by Intel E5-2680v2 CPUs, a powerful network, great RAM-per-dollar, ultra-low pricing, and very low ping to major online services and platforms. Perfect for projects on a tight budget.</p>
                <p className="text-content-muted text-[13px] leading-relaxed">
                  2.8 GHz Xeon E5-2680v2・Neoprotect DDoS protection・99.99% avg. uptime・SSD・DDR3 RAM・Advanced cooling・ultra-low pricing
                </p>
              </div>
              <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-offset="30" className="purple-glow-card md:col-span-2 md:w-1/2 md:justify-self-center">
                <div className="flex flex-col items-start gap-2 mb-2">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className={`space-y-6`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div data-aos="fade-up" data-aos-duration="700" className="md:col-span-2 rounded-2xl bg-feature-card p-6">
                ...
                <div data-aos="fade-up" data-aos-duration="700" data-aos-delay="200" className="rounded-2xl bg-feature-card-br p-6">
                  <div className="flex items-center gap-3 mb-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div data-aos="fade-up" data-aos-duration="700" className="rounded-2xl bg-feature-card-br p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-12 w-12 rounded-xl bg-blue-500/10 flex items-center justify-center">
        ...
        <div className="relative w-full mt-20" id="faq-section">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-12">
              <span data-aos="fade-up" data-aos-duration="900" className="text-cyan-500 text-sm p-2 px-5 rounded-full bg-linear-to-t from-transparent relative font-semibold gradient-border-purple"
                style={{
                  border: '1px solid transparent',
                }}>
            ...
            <div>
              <FAQ items={[
                ...
                },
                {
                  ...
                  answer: "We currently operate in 3 locations, in Dallas, US, Frankfurt, Germany, and Utah, US. We are planning to expand more in the future."
                },
                {
