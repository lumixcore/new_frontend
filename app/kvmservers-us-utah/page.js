...
export default function KvmrootServerPlansUS() {
  ...
  const kvmRootserverPlans = [
    {
      planName: "KVM Rootserver U1",
      price: "6.5",
      currency: "$",
      features: [
        { resource: "CPU", value: "4 vCores" },
        { resource: "RAM", value: "12GB" },
        { resource: "Storage", value: "120GB SSD" },
        { resource: "IPv4", value: "1 included" },
        { resource: "Uplink", value: "10 Gbps" },
        { resource: "Bandwidth", value: "Unmetered" }
      ]
    },
    {
      planName: "KVM Rootserver U2",
      price: "8.5",
      currency: "$",
      features: [
        { resource: "CPU", value: "8 vCores" },
        { resource: "RAM", value: "18GB" },
        { resource: "Storage", value: "210GB SSD" },
        { resource: "IPv4", value: "1 included" },
        { resource: "Uplink", value: "10 Gbps" },
        { resource: "Bandwidth", value: "Unmetered" }
      ]
    ...
    {
      planName: "KVM Rootserver U3",
      price: "12",
      currency: "$",
      features: [
        { resource: "CPU", value: "12 vCores" },
        { resource: "RAM", value: "32GB" },
        { resource: "Storage", value: "320GB SSD" },
        { resource: "IPv4", value: "1 included" },
        { resource: "Uplink", value: "10 Gbps" },
        { resource: "Bandwidth", value: "Unmetered" }
      ]
        ...
        <div className="flex flex-col max-w-6xl mx-auto mt-40 mb-5 p-5 w-full">
          <div className={`flex flex-col items-center text-center z-10`}>
            ...
            <p className={`text-lg text-gray-400 mb-8 max-w-3xl text-left md:text-center`} style={{marginTop: '-10px'}} data-aos="fade-up" data-aos-duration="700" data-aos-delay="200">
              Powered by <span className="text-cyan-500">2.8 GHz Intel E5-2680v2</span> and hosted in Utah, US data center. You get full root access, dedicated CPU cores, RAM, and SSD storage for true bare metal performance with virtualization flexibility. Plans start at only <span className="text-cyan-300">$6.5</span> per month.
            </p>
          </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-5 mt-12 mr-5 ml-5 mb-5 flex-col sm:flex-row">
            <div className="flex flex-col items-center text-center p-4 max-w-sm " data-aos="fade-up" data-aos-duration="700" data-aos-delay="600" data-aos-offset="5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Host your KVM Rootservers in Utah, US. Our infrastructure had avg. 99% uptime this year. While providing low latency to major online platforms.
              </p>
            </div>
        ...
        <div className="w-full mt-30 overflow-hidden rounded-t-[40px]" id="pricing-section">
          <div className={`max-w-[85rem] mx-auto px-6`}>
            <div className="text-left mb-10 pt-2">
              ...
              <p className="text-sm text-gray-400 leading-6 max-w-2xl">See our KVM Rootserver pricing. All plans include 1x IPv4, neoprotect DDoS protection, 2.8 GHz Intel E5-2680v2, SSD drives. Delivered within 24 hours.</p>
            </div>
              ...
              {kvmRootserverPlans.map((plan, index) => (
                <div key={index} className="w-full min-[570px]:max-w-sm mb-5">
                  <PricingCard
                    ...
                    url="https://panel.lumixcore.com/store/kvmserver-us-utah"
                  />
                </div>
              ))}
            </div>
