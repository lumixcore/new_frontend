      ...
      <div className="bg-page overflow-hidden">
        ...
        <div className="flex flex-col max-w-6xl mx-auto mt-40 mb-5 p-5 w-full">
          <div className={`flex flex-col items-center text-center z-10`}>
            <h1 className="bg-gradient-to-r from-cyan-200 to-blue-400 bg-clip-text text-transparent text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6 max-w-4xl tracking-wider" style={{ fontFamily: 'Nohemi, sans-serif', fontWeight: '300' }} data-aos="fade-up" data-aos-duration="700">
              Web hosting powered by cloud containers
            </h1>
            <p className={`text-lg text-gray-400 mb-1 max-w-3xl text-left md:text-center`} style={{marginTop: '-10px'}} data-aos="fade-up" data-aos-duration="700" data-aos-delay="200">
              Run your static website inside the same lightweight cloud containers we use for our standard hosting. No OS hassle, full panel control, and the same flexible container plans that support games, bots, and apps.
            </p>
            <a
        ...
        <div className="flex flex-wrap justify-center items-center gap-5 mt-12 mr-5 ml-5 mb-5 flex-col sm:flex-row">
            <div className="flex flex-col items-center text-center p-4 max-w-sm " data-aos="fade-up" data-aos-duration="700" data-aos-delay="600" data-aos-offset="5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Our webservers can be hosted in 2 different locations, in Dallas, US and Frankfurt, Germany.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-4 max-w-sm " data-aos="fade-up" data-aos-duration="700" data-aos-delay="800" data-aos-offset="5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Our webservers are extremely affordable. Making it ideal for users who want to host multiple projects at a low cost.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-4 max-w-sm " data-aos="fade-up" data-aos-duration="700" data-aos-delay="1000" data-aos-offset="5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                We use Docker's lightweight virtualization. Each webserver runs in its own isolated environment. No VM bloat, just pure efficiency.
              </p>
            </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto mt-8">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-left" data-aos="fade-up" data-aos-duration="700" data-aos-delay="300">
            <p className="text-white text-lg font-semibold mb-4">Our cloud containers can host absolutely anything, including <span className="text-cyan-400">websites.</span></p>
            <p className="text-sm text-gray-400 mb-6">If you want to host a website, please see our cloud containers pricing page. <span className="text-cyan-500">Make sure you choose the correct plan based on your website's resource demands (CPU, RAM, storage).</span></p>
            <a href={pricingLink} className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-surface-elevated text-white border border-cyan-500/20 hover:border-cyan-500/40 transition-colors duration-200 font-semibold">
