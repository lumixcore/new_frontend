...
export default function Ipv6KvmrootServerPlansDE() {
  ...
  const kvmRootserverPlans = [
    {
      planName: "IPv6 KVM Rootserver DX1",
      price: "3.30",
      currency: "$",
      billingPeriod: "monthly",
      features: [
        { resource: "CPU", value: "1 vCores" },
        { resource: "RAM", value: "6GB" },
        { resource: "Storage", value: "40GB NVMe" },
        { resource: "IPv4", value: "Not included" },
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1Gbit" },
        { resource: "Bandwidth", value: "5TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX2",
      price: "5.50",
      currency: "$",
      features: [
        { resource: "CPU", value: "2 vCores" },
        { resource: "RAM", value: "8GB" },
        { resource: "Storage", value: "50GB NVMe" },
        { resource: "IPv4", value: "Not included" },
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "10TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX3",
      price: "6.65",
      currency: "$",
      features: [
        ...
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "15TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX4",
      price: "9.50",
      currency: "$",
      features: [
        { resource: "CPU", value: "4 vCores" },
        ...
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "20TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX5",
      price: "13",
      currency: "$",
      features: [
        ...
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "25TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX6",
      price: "19.50",
      currency: "$",
      features: [
        { resource: "CPU", value: "6 vCores" },
        { resource: "RAM", value: "36GB" },
        { resource: "Storage", value: "250GB NVMe" },
        { resource: "IPv4", value: "Not included" },
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "30TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX7",
      price: "26",
      currency: "$",
      features: [
        { resource: "CPU", value: "8 vCores" },
        { resource: "RAM", value: "48GB" },
        { resource: "Storage", value: "300GB NVMe" },
        { resource: "IPv4", value: "Not included" },
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "35TB" }
      ]
    },
    {
      planName: "IPv6 KVM Rootserver DX8",
      price: "39",
      currency: "$",
      features: [
        { resource: "CPU", value: "8 vCores" },
        { resource: "RAM", value: "64GB" },
        { resource: "Storage", value: "350GB NVMe" },
        { resource: "IPv4", value: "Not included" },
        { resource: "IPv6", value: "1x /64 included" },
        { resource: "Uplink", value: "1 Gbit" },
        { resource: "Bandwidth", value: "40TB" }
      ]
    },
  ];
      ...
      <div className="bg-page overflow-hidden">
        ...
        <div className="flex flex-col max-w-6xl mx-auto mt-40 mb-5 p-5 w-full">
          <div className={`flex flex-col items-center text-center z-10`}>
            <h1 className="bg-gradient-to-r from-cyan-200 to-blue-400 bg-clip-text text-transparent text-5xl md:text-6xl lg:text-7xl mb-6 tracking-wider" style={{ fontFamily: 'Nohemi, sans-serif', fontWeight: '300' }} data-aos="fade-up" data-aos-duration="700">
              DE IPv6 KVM Rootservers
            </h1>
            <p className={`text-lg text-gray-400 mb-8 max-w-3xl text-left md:text-center`} style={{marginTop: '-10px'}} data-aos="fade-up" data-aos-duration="700" data-aos-delay="200">
              Powered by <span className="text-cyan-500">2.7 GHz Intel Xeon 6150 processors</span> and hosted in Frankfurt, Germany data center. You get full root access, dedicated CPU cores, RAM, and SSD storage for true bare metal performance with virtualization flexibility. Plans start at only <span className="text-cyan-300">$3.30</span> per month.
            </p>
          </div>
          <div className={`grid grid-cols-1 min-[570px]:grid-cols-2 gap-4 w-full max-w-lg mx-auto`} data-aos="fade-up" data-aos-duration="700" data-aos-delay="400">
            ...
            <button className="px-8 py-3 text-white bg-surface-elevated rounded-full transition-all border border-cyan-500/20 hover:border-cyan-500/40 flex items-center justify-center group" onClick={() => router.push('/kvmservers-de')}>
              IPv4 Frankfurt Plans
              <svg className="w-4 h-4 ml-2 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
              </svg>
            </button>
        ...
        <div className="flex flex-wrap justify-center items-center gap-5 mt-12 mr-5 ml-5 mb-5 flex-col sm:flex-row">
            <div className="flex flex-col items-center text-center p-4 max-w-sm " data-aos="fade-up" data-aos-duration="700" data-aos-delay="600" data-aos-offset="5">
              ...
              <h3 className="text-white font-semibold text-lg mb-3">Germany location</h3>
              <p className="text-sm text-gray-400 leading-relaxed">
                Host your KVM Rootservers in Frankfurt, Germany. Our infrastructure provides 99.99% average uptime, located at one of Europe's largest internet exchange points.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-4 max-w-sm " data-aos="fade-up" data-aos-duration="700" data-aos-delay="1000" data-aos-offset="5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                KVM virtualization gives you fully isolated root servers with dedicated CPU, RAM, and storage on our EU hardware. Full root access and bare metal performance.
              </p>
            </div>
        </div>
        ...
        <div className="w-full mt-30 overflow-hidden rounded-t-[40px]" id="pricing-section">
          <div className={`max-w-[85rem] mx-auto px-6`}>
            <div className="text-left mb-10 pt-2">
              ...
              <h2 className="text-3xl text-white mb-1 mt-5" style={{fontFamily: 'Nohemi, sans-serif', fontWeight: '300'}}>IPv6 KVM Rootservers pricing</h2>
              <p className="text-sm text-gray-400 leading-6 max-w-2xl">See our IPv6 KVM Rootserver pricing. All plans include 1x /64 IPv6, 3.2 Tbit DDoS protection, 2.7Ghz Intel Xeon 6150 CPU, NVMe drives, 1 Gbit Uplink per server, 4 backups. Delivered within 24 hours.</p>
            </div>
              ...
              {kvmRootserverPlans.map((plan, index) => (
                <div key={index} className="w-full min-[570px]:max-w-sm mb-5">
                  <PricingCard
                    ...
                    url="https://panel.lumixcore.com/store/ipv6-kvmserver-de"
                  />
                </div>
              ))}
            </div>
